-- Io. Open world: authored population per zone, respawns and public event sites.
...
local mission = require(missions.EDEN_FREEROAM)
local freeroam = require("lib.freeroam")
local content = require("eden_freeroam.content")
